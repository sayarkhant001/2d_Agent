...
class ComposeUiIntegrationTest {
    ...
    fun testAgentSettlementCardTutAndExactClick() {
        ...
        val tutSettlement = AgentSettlement(
            ...
            remaining = -606_750L,
            tuwtDetails = listOf(
                com.twoDLedger.ui.TutWinDetail("641", 3000L, 30_000L),
                com.twoDLedger.ui.TutWinDetail("604", 1000L, 10_000L)
            ),
            exactDetails = listOf(
                com.twoDLedger.ui.TutWinDetail("123", 1000L, 600_000L)
            )
        )
    ...
    fun testWinBreakdownDialogDisplaysItems() {
        ...
        var dismissed = false
        composeTestRule.setContent {
            com.twoDLedger.ui.WinBreakdownDialog(
    ...
    fun testExportHistoryBottomBarDisplaysTotalSent() {
        composeTestRule.setContent {
            com.twoDLedger.ui.ExportHistoryBottomBar(
                totalAmount = 16_000L,
                totalVouchers = 1,
                totalNumbers = 6,
                selectedBatch = 15
    ...
    fun testCustomerCardDisplaysFinancialsAndNavigates() {
        ...
        composeTestRule.setContent {
            com.twoDLedger.ui.CustomerCard(
                customer = customer,
