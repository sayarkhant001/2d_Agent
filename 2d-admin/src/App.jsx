  ...
  const fetchOfficialGlo = async () => {
    ...
    try {
      ...
      if (data) {
        ...
        showToast(`2D Result (${sourceLabel}): 3D = ${data.threeD} (1st = ${data.firstPrize})`);
      } else {
    ...
    <div className="dashboard">
      ...
      <header className="dashboard-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <img src="/app_logo.jpg" alt="2D စာရင်း" className="header-app-logo" />
          <div>
            <h1 style={{ margin: 0, lineHeight: 1.2 }}><span>2D Lottery Admin</span></h1>
            <div style={{ fontSize: 11, color: 'var(--text-muted)', fontWeight: 600 }}>2D စာရင်း PRO စီမံခန့်ခွဲမှုစနစ်</div>
          </div>
          <span style={{
            fontSize: 11,
      ...
      <div className="section-nav-wrapper">
        <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 16px' }}>
          <nav className="section-nav">
            ...
            >
              <span className="tab-icon">🎯</span>
              <span className="tab-title">2D Lottery & Results (ထိုင်း 3D နှင့် ရလဒ်)</span>
      ...
      <main className="dashboard-content">
          ...
          <div className="page-breadcrumb-bar">
            <div className="breadcrumb-path">
              ...
              <span className="breadcrumb-current">
                ...
                {activeSection === 'lottery' && '🎯 2D Lottery Draw & Official GLO (ထိုင်း 3D နှင့် ရလဒ်)'}
          ...
          <div className="overview-page-container">
            ...
            <div className="stats-row">
              ...
              <div
                ...
                onClick={() => { setActiveSection('lottery'); }}
                style={{ cursor: 'pointer' }}
                title="View 2D Live Draw & Results"
              >
                <div className="stat-icon">🎯</div>
                <div className="stat-value">{liveResults.winning_number || '---'}</div>
                <div className="stat-label">2D ပေါက်ဂဏန်း (Winning 3D)</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="quick-actions-grid">
                ...
                >
                  ...
                  <div className="quick-action-body">
                    <div className="quick-action-name">
                      <span>2D Live Draw & GLO Scraper</span>
                      <span className="quick-action-arrow">→</span>
                    </div>
                    <div className="quick-action-desc">
                ...
                >
                  ...
                  <div className="quick-action-body">
                    <div className="quick-action-name">
                      <span>2D Analysis Simulator</span>
                      <span className="quick-action-arrow">→</span>
                    </div>
                    <div className="quick-action-desc">
                      Interactive test bench for Myanmar 2D Analysis permutations (5 reversal digits) and cyclic near-miss neighbor boundaries.
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div>
                ...
                {gloResult ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                    ...
                    <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center' }}>
                      ...
                      >
                        ⚡ Apply 2D Result to Live App & Telegram
                      </button>
                      <button
                        type="button"
                        className="btn btn-outline btn-sm"
            ...
            <div className="card">
              <div className="card-header">
                <h2>🎯 Manual 2D Result Declaration (လက်စွဲ ရလဒ် ကြေညာချက်)</h2>
              </div>
              <div className="card-body">
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  <div className="form-group">
                    <label>2D Winning Number (ပေါက်ဂဏန်း ၃ လုံး)</label>
                    <input
                      type="text"
                      maxLength={3}
                      value={manualNumber}
                  ...
                  >
                    🚀 Publish 2D Result (ရလဒ် ထုတ်ပြန်မည်)
                  </button>
        ...
        {activeSection === 'calculator' && (
          <div style={{ maxWidth: 760, margin: '0 auto' }}>
            <div className="card">
              <div className="card-header">
                <h2>🧪 2D Analysis Simulator (တွတ် စမ်းသပ်တွက်စက်)</h2>
              </div>
              <div className="card-body">
                <div className="form-group">
